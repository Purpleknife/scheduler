...
test("getInterviewersForDay returns an empty array when the interview data is empty", () => {
  const result = getInterviewersForDay({ days: [] }, "Monday");
  expect(result.length).toEqual(0);
});

test("getInterviewersForDay returns an empty array when the interview is not found", () => {
